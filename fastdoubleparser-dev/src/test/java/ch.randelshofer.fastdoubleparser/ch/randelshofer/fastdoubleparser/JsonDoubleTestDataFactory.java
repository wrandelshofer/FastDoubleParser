...
public abstract class JsonDoubleTestDataFactory {
    ...
    public static List<NumberTestData> createFloatTestDataForInputClassesInMethodParseNumber() {
        return Arrays.asList(
                ...
                new NumberTestData("parseNumber(): With illegal FloatTypeSuffix 'z': 1.2e3z", "1.2e3z", 0, 6, 0, 6, 10, 1.2e3, AbstractNumberParser.SYNTAX_ERROR, NumberFormatException.class, Locale.ENGLISH),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'd': 1.2e3d", "1.2e3d", 0, 6, 0, 6, 10, 1.2e3, AbstractNumberParser.SYNTAX_ERROR, NumberFormatException.class, Locale.ENGLISH),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'd' + whitespace: 1.2e3d ", "1.2e3d ", 0, 7, 0, 7, 10, 1.2e3, AbstractNumberParser.SYNTAX_ERROR, NumberFormatException.class, Locale.ENGLISH),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'D': 1.2D", "1.2D", 0, 4, 0, 4, 10, 1.2, AbstractNumberParser.SYNTAX_ERROR, NumberFormatException.class, Locale.ENGLISH),
                ...
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'F': -1.2e-3F", "-1.2e-3F", 0, 8, 0, 8, 10, -1.2e-3, AbstractNumberParser.SYNTAX_ERROR, NumberFormatException.class, Locale.ENGLISH),
