 ...
 * </dl>
 */
public class FastDoubleParserOld {
    private final static long MINIMAL_NINETEEN_DIGIT_INTEGER = 1000_00000_00000_00000L;
    /**
     * Double only has a range of -324 to +308
     */
    final static int MAX_EXPONENT_NUMBER = 324;
    /**
    ...
    private static double parseRestOfDecimalFloatLiteral(CharSequence str, int index, int startIndex, int endIndex, boolean isNegative, boolean hasLeadingZero) {
        ...
        double result = FastDoubleMath.decFloatLiteralToDouble(isNegative, digits, exponent, isDigitsTruncated,
