...
class FastDoubleMath {
    ...
    static UInt128 fullMultiplication1(long x, long y) {//since Java 18
        return fullMultiplication(x, y);
    ...
    static long unsignedMultiplyHigh(long x, long y) {//since Java 18
        return unsignedMultiplyHighJava1(x, y);
    }
/*
    static long unsignedMultiplyHighJava18(long x, long y) {//since Java 18
