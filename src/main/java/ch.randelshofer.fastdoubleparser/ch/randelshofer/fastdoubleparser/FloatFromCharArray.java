 ...
 */
final class FloatFromCharArray extends AbstractFloatValueFromCharArray {

    static final FloatFromCharArray INSTANCE = new FloatFromCharArray();

    private FloatFromCharArray() {
