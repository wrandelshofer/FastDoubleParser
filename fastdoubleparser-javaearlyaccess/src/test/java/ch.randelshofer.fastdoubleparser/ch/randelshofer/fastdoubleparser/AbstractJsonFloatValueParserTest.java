...
public abstract class AbstractJsonFloatValueParserTest extends AbstractFloatValueParserTest {
    ...
    protected List<NumberTestData> createFloatTestDataForInputClassesInMethodParseNumber() {
        return Arrays.asList(
                new NumberTestData("parseNumber(): charOffset too small", "3.14", -1, 4, -1, 4, AbstractNumberParser.ILLEGAL_OFFSET_OR_ILLEGAL_LENGTH),
                new NumberTestData("parseNumber(): charOffset too big", "3.14", 8, 4, 8, 4, AbstractNumberParser.ILLEGAL_OFFSET_OR_ILLEGAL_LENGTH),
                new NumberTestData("parseNumber(): charLength too small", "3.14", 0, -4, 0, -4, AbstractNumberParser.ILLEGAL_OFFSET_OR_ILLEGAL_LENGTH),
                new NumberTestData("parseNumber(): charLength too big", "3.14", 0, 8, 0, 8, AbstractNumberParser.ILLEGAL_OFFSET_OR_ILLEGAL_LENGTH),
                new NumberTestData("parseNumber(): Significand with leading whitespace", "   3", 0, 4, 0, 4, AbstractNumberParser.SYNTAX_ERROR),
                ...
                new NumberTestData("parseNumber(): NaN", "NaN", 0, 3, 0, 3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): Leading zero", "03", 0, 2, 0, 2, 3d),
                new NumberTestData("parseNumber(): Leading zeroes", "003", 0, 3, 0, 3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): Leading zero x", "0x3", 0, 3, 0, 3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): Leading zero X", "0X3", 0, 3, 0, 3, AbstractNumberParser.SYNTAX_ERROR),

                new NumberTestData("parseNumber(): Decimal point only", ".", 0, 1, 0, 1, AbstractNumberParser.SYNTAX_ERROR),
                ...
                new NumberTestData("parseNumber(): 1 digit + 7 chars after decimal point", "3.1abcdefg", 0, 10, 0, 10, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With 'e' at end", "3e", 0, 2, 0, 2, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With 'E' at end", "3E", 0, 2, 0, 2, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With 'e' + whitespace at end", "3e   ", 0, 5, 0, 5, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With 'E' + whitespace  at end", "3E   ", 0, 5, 0, 5, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With 'e+' at end", "3e+", 0, 3, 0, 3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With 'E-' at end", "3E-", 0, 3, 0, 3, AbstractNumberParser.SYNTAX_ERROR),
                ...
                new NumberTestData("parseNumber(): With 20 significand digits + non-ascii char", "12345678901234567890￡", 0, 21, 0, 21, AbstractNumberParser.SYNTAX_ERROR),
                ...
                new NumberTestData("parseNumber(): With illegal FloatTypeSuffix 'z': 1.2e3z", "1.2e3z", 0, 6, 0, 6, 1.2e3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'd': 1.2e3d", "1.2e3d", 0, 6, 0, 6, 1.2e3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'd' + whitespace: 1.2e3d ", "1.2e3d ", 0, 7, 0, 7, 1.2e3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'D': 1.2D", "1.2D", 0, 4, 0, 4, 1.2, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'f': 1f", "1f", 0, 2, 0, 2, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): With FloatTypeSuffix 'F': -1.2e-3F", "-1.2e-3F", 0, 8, 0, 8, -1.2e-3, AbstractNumberParser.SYNTAX_ERROR),
                new NumberTestData("parseNumber(): No digits+whitespace+'z'", ". z", 0, 2, 0, 2, AbstractNumberParser.SYNTAX_ERROR)
