...
final class JavaBigDecimalFromCharSequence extends AbstractNumberParser {
    ...
    private BigInteger parseDigits(CharSequence str, int from, int to, Map<Integer, BigInteger> powersOfTen, int parallelThreshold) {
        int numDigits = to - from;
    ...
    private BigDecimal valueOfBigDecimalString(CharSequence str, int integerPartIndex, int decimalPointIndex, int nonZeroFractionalPartIndex, int exponentIndicatorIndex, boolean isNegative, int exponent, int parallelThreshold) {
    ...
    static class ParseDigitsTask extends RecursiveTask<BigInteger> {
        ...
        ParseDigitsTask(CharSequence str, int from, int to, Map<Integer, BigInteger> powersOfTen, int parallelThreshold) {
            this.from = from;
            this.to = to;
            this.str = str;
        ...
        protected BigInteger compute() {
            ...
            // Recursion case:
            int mid = splitFloor16(from, to);
            JavaBigIntegerFromCharSequence.ParseDigitsTask high = new JavaBigIntegerFromCharSequence.ParseDigitsTask(str, from, mid, powersOfTen, parallelThreshold);
            JavaBigIntegerFromCharSequence.ParseDigitsTask low = new JavaBigIntegerFromCharSequence.ParseDigitsTask(str, mid, to, powersOfTen, parallelThreshold);
