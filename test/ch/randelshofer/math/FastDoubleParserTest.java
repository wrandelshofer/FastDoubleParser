...
class FastDoubleParserTest {
    ...
    Stream<DynamicNode> dynamicTestsPowerOfTen() {
       ...
       return Arrays.stream(testing_power_of_ten)
        .mapToObj(d->dynamicTest(d+"",()->testLegalInput(d+"",d)))                ;
    }
    ...
    private void testLegalInput(String s, double expected) {
        double actual = FastDoubleParser.parseDouble(s);
